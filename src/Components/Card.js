...
export const Card = ({icon,name, color, amount,percent, cal })=>{
    return <div className="bg-white rounded-md flex aspect-[5/3] gap-2 items-center p-5 ">
        <div className={`${color}  rounded-full lg:p-6 md:p-8  p-20`} > 
            {icon}
         </div>
        <div className="my-auto mx-auto">
            <h1 className="lg:text-xs md:text-xl   text-3xl text-gray-400">{name}</h1>
            <h1 className="lg:text-xl md:text-lg text-6xl font-bold">{amount}</h1>
            <h1 className="lg:text-xs md:text-sm text-3xl  text-gray-400 items-center flex gap-1">
